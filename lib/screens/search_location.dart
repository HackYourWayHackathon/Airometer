                ...
                child: Column(
                  children: [
                    Container(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          filled: true,
                          fillColor: Color.fromRGBO(224, 221, 224, 1),
                          hintText: "Search Location",
                          hintStyle: TextStyle(
                            fontSize: 18,
                            color: Colors.deepPurple
                          ),
                          suffixIcon: Icon(Icons.location_city,color: Colors.deepPurple,),
                    ...
                    Container(
                      ...
                      color: Color.fromRGBO(235, 231, 235, 1),
                      height: 400,
                                      ...
                                      children: List.generate(
                                        ...
                                        (index) {
                                          ...
                                          return Padding(
                                            ...
                                            child: ListTile(
                                              onTap: ()async{
                                                List<Location> location = await locationFromAddress(place.city);
                                              ...
                                              title: Text("${place.city}",style: TextStyle(
                                                color: Colors.blue
                                              ),),
                                              subtitle: Text("${place.state},${place.country}",style: TextStyle(
                                                color: Colors.black
                                              ),
                                              ),
                                            ),
